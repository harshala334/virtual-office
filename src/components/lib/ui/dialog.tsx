...
50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200
...
[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-
[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-infrom-top-[48%] sm:rounded-lg",
className
)}
{...props}
>
...
disabled:pointer-events-none data-[state=open]:bg-accent data-
