...
text-sm font-medium outline-none focus:bg-accent focus:text-accent-foreground
...
text-sm outline-none focus:bg-accent focus:text-accent-foreground data-
...
[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-
[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-
[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-
[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
className
)}
{...props}
/>
